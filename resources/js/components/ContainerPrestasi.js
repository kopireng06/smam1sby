...
const ContainerPrestasi = () => {
    ...
    return (  
        <div className="relative md:absolute right-0 h-auto pb-5 md:h-full w-full md:w-6/12 lg:w-4/12 bg-white">
            <div className="text-4xl px-5 mt-5 text-smam1 text-white font-bold mb-8 md:mb-14">
                PRESTASI
            </div>
            <div className="mx-auto md:ml-8 mb-12 md:mb-0 max-w-sm md:max-w-xs-2 pb-2 rounded-md bg-white shadow-md flex flex-col">
            ...
            <div className="md:max-w-xs-2 w-full md:ml-8 absolute bottom-0 flex justify-end h-10">
