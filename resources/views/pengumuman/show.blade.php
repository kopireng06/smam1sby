                ...
                <div class="col-md-12">
                    <div class="panel">
					    <div class="panel-heading">
                            <h1 class="panel-title">Edit Pengumuman</h1>
                        </div>  
                        ...
                        <form action="{{ route('pengumuman.update', $pengumuman->id_pengumuman) }}" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="judul_pengumuman" class="form-control @error('judul_pengumuman') is-invalid @enderror" value="{{ $pengumuman->judul_pengumuman }}" required/>
